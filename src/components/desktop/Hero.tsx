...
export default function Hero() {
  ...
  return (
    <section id="home" className={`${satoshi.variable} ${montserrat.variable} ${pixelFont.variable} relative min-h-screen flex items-center justify-center`}>
      {/* Grid SVG Background */}
      ...
      <div className="relative z-10 w-full flex justify-center">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-8 flex items-center justify-center gap-4">
          ...
          <p className="font-[family-name:var(--font-montserrat)] text-lg md:text-xl lg:text-2xl text-gray-300 max-w-4xl mb-12 leading-relaxed">
      ...
      <div className="absolute left-36 bottom-0 flex items-center">
