...
export default function AboutSection() {
  ...
  return (
    <section 
      id="about"
      className={`${satoshi.variable} ${montserrat.variable} h-screen overflow-hidden relative flex flex-col items-center justify-center px-4 py-16 md:flex-row md:px-6 md:py-0 xl:px-0`}
    >
