...
export default function ContactSection() {
  return (
    <section 
      id="contact"
      className={`${satoshi.variable} h-screen overflow-hidden bg-transparent relative flex flex-col items-center justify-center px-4 py-16 md:px-6 md:py-0 xl:px-0`}
    >
