...
export default function ContactSection() {
  return (
    <section 
      id="contact"
      className={`${satoshi.variable} h-screen overflow-hidden bg-[#0c0c0c] relative flex flex-col items-center justify-center px-4 py-16 md:px-6 md:py-0 xl:px-0`}
    >
      ...
      <div className="relative z-10 w-full text-center md:max-w-lg md:mx-auto xl:max-w-4xl xl:px-8">
        ...
        <div className="flex flex-col gap-3 mb-12 md:flex-row md:gap-4 md:justify-center xl:gap-6 xl:mb-16">
          ...
          <button 
            ...
            className="w-full border border-dashed border-[#E9F5DB] text-[#E9F5DB] px-4 py-3 rounded-md font-medium hover:bg-[#E9F5DB] hover:text-black transition-colors md:w-auto md:px-6 xl:px-8"
          >
            View my Resume
          </button>
        </div>
