...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} id="home" className={`${satoshi.variable} ${montserrat.variable} ${pixelFont.variable} relative min-h-screen flex flex-col items-center justify-center px-4 py-16 md:flex-row md:px-8 md:py-0 xl:px-0`}>
