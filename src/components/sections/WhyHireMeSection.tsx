...
export default function WhyHireMeSection() {
  ...
  return (
    <>
      ...
      <section id="why-hire-me" className={`${fontClasses} h-screen overflow-hidden relative bg-[#0c0c0c]/80 px-4 py-16 flex flex-col md:px-6 md:py-0 xl:px-0 xl:block`}>
        ...
        <div className="hidden md:flex xl:hidden h-2/3 flex-col items-center justify-center z-10">
          ...
          <div className="w-full bg-[#0c0c0c]/80 px-4 text-center">
      ...
      <section className={`${fontClasses} h-screen overflow-hidden relative bg-[#0c0c0c]/80 px-4 py-16 flex flex-col items-center justify-center md:px-6 md:py-0 xl:px-0`}>
      ...
      <section className={`${fontClasses} h-screen overflow-hidden relative bg-[#0c0c0c]/80 px-4 py-16 flex flex-col items-center justify-center md:px-6 md:py-0 xl:px-0`}>
        ...
        <div className="hidden md:flex xl:hidden flex-col items-center justify-center">
          ...
          <div className="w-full px-4 text-center bg-[#0c0c0c]/80 z-10">
            <div className="max-w-md mx-auto mb-10">
