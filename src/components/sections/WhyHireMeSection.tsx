...
export default function WhyHireMeSection() {
  ...
  return (
    <>
      ...
      <section id="why-hire-me" className={`${fontClasses} h-screen overflow-hidden relative px-4 py-16 flex flex-col md:px-6 md:py-0 xl:px-0 xl:block`}>
      ...
      <section className={`${fontClasses} h-screen overflow-hidden relative px-4 py-16 flex flex-col items-center justify-center md:px-6 md:py-0 xl:px-0`}>
