...
function MobileWork() {
  ...
  return (
    <section id="work" className={`${fontClasses} min-h-screen bg-[#0c0c0c] relative flex flex-col items-center py-16 px-4 md:hidden`}>
...
function TabletProjectViewport({ project, isFirst }: { project: typeof projects[0], index: number, isFirst?: boolean }) {
  ...
  return (
    <section id={isFirst ? 'work' : undefined} className={`${fontClasses} h-screen bg-[#0c0c0c] relative flex flex-col items-center justify-center px-6`}>
      {isFirst && (
        <div className="mb-16">
...
function DesktopProjectViewport({ project, isFirst }: { project: typeof projects[0], index: number, isFirst?: boolean }) {
  ...
  return (
    <section id={isFirst ? 'work' : undefined} className={`${fontClasses} h-screen bg-[#0c0c0c] relative flex ${isFirst ? 'flex-col' : ''} items-center justify-center`}>
      {isFirst && (
        <div className="mb-24">
