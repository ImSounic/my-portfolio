...
function MobileWork() {
  ...
  return (
    <section className={`${fontClasses} h-screen overflow-hidden bg-transparent relative flex flex-col items-center py-16 px-4 md:hidden`}>
...
function TabletProjectViewport({ project, isFirst }: { project: typeof projects[0], index: number, isFirst?: boolean }) {
  ...
  return (
    <section className={`${fontClasses} h-screen overflow-hidden bg-transparent relative hidden md:flex xl:hidden flex-col items-center justify-center px-6`}>
      {isFirst && (
        <div className="mb-16">
...
function DesktopProjectViewport({ project, isFirst }: { project: typeof projects[0], index: number, isFirst?: boolean }) {
  ...
  return (
    <section className={`${fontClasses} h-screen overflow-hidden bg-transparent relative hidden xl:flex ${isFirst ? 'flex-col' : ''} items-center justify-center`}>
      {isFirst && (
        <div className="mb-24">
