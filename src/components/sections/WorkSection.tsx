...
const projects = [
  {
    ...
    image: '/projects/crypto-microstructure.jpg',
  ...
  },
  {
    ...
    image: '/projects/miscarriage-prediction.jpg',
...
function MobileCarousel() {
  ...
  return (
    <section className={`${fontClasses} h-screen overflow-hidden relative flex flex-col items-center py-16 px-4 md:hidden`}>
...
function TabletCarousel() {
  ...
  return (
    <section className={`${fontClasses} h-screen overflow-hidden relative hidden md:flex xl:hidden flex-col items-center pt-24 px-6`}>
...
function DesktopCarousel() {
  ...
  return (
    <section className={`${fontClasses} h-screen overflow-hidden relative hidden xl:flex flex-col items-center pt-28`}>
