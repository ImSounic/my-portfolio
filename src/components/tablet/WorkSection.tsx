...
export default function WorkSection() {
  return (
    <>
      ...
      <section id="work" className={`${satoshi.variable} ${montserrat.variable} h-screen bg-black relative snap-start flex flex-col items-center justify-center px-6`}>
      ...
      <section className={`${satoshi.variable} ${montserrat.variable} h-screen bg-black relative flex flex-col items-center justify-center snap-start px-6`}>
        <div className="w-full max-w-lg mx-auto">
          <div className="relative flex flex-col">
            {/* Project Title */}
            <h3 className="font-[family-name:var(--font-satoshi)] text-3xl font-bold text-white text-center mb-4">
