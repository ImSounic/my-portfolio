...
export default function WorkSection() {
  return (
    <>
      ...
      <section className={`${satoshi.variable} ${montserrat.variable} h-screen bg-black relative flex items-center justify-center snap-start`}>
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="relative">
            {/* Circle Icon - Bottom Right (Behind) */}
            <div className="absolute -bottom-20 -right-[-60px] w-40 h-40 z-0">
        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="relative">
            ...
            <div className="relative w-full h-[500px] z-10">
              ...
              {/* Internship Badge */}
              {projects[2].company && (
                <div className="absolute bottom-[-24px] left-48 bg-black/80 text-white px-4 py-2 rounded-lg z-10">
